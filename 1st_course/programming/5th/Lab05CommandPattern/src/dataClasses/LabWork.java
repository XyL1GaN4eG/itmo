...
/**
 * Класс dataClasses.LabWork представляет собой лабораторную работу.
...
public class LabWork {
    ...
    /**
     * Вложенный класс LabWorkBuilder используется для построения экземпляров dataClasses.LabWork.
     */
    public static class LabWorkBuilder {
        ...
        // Методы для установки значений полей лабораторной работы...
...
//        };
    ...
    public int[] getLen() {
        ...
        if (this.author != null) {
            // Check and handle author fields
