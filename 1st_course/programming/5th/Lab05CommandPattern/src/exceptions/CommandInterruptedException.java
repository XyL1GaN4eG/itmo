...
public class CommandInterruptedException extends RuntimeException {
    ...
    /**
     * Constructs a new exceptions.CommandInterruptedException with the specified cause.
     *
    ...
    public CommandInterruptedException(String message, Throwable throwable) { super(message, throwable);}
}