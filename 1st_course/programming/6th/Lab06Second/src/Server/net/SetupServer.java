...
import static Server.rsc.ServerGlobalVars.*;

public class SetupServer {
    public static void getLabsFromFile() {
        File file = new File(PATH_TO_DATA + "data.txt");
//        System.out.println(PATH_TO_DATA + "data.txt");

        file.delete();
        ZonedDateTime initializationDate = ZonedDateTime.now();
        FileManager.writeStrToFilename(String.valueOf(initializationDate), PATH_TO_DATA + "data.txt");
