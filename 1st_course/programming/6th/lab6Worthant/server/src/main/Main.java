...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Записываем в лог информацию о коллекции
            ...
            logger.info("Now server is listening to requests.");
        ...
        // Главный цикл для обработки входящих запросов
        while (true) {
            try {
                // Слушаем и получаем данные от клиента
                ...
                // Проверяем, доступен ли ввод в System.in
                try {
