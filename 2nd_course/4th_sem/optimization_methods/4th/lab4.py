...
def f(x_1, x_2, ex=0): # y(x) -> y но если надо вернуть не значение, а сам y(x), то это lambda
    if ex == 2:
        return f'2 * ({x_1}) ** 2 + 4 * ({x_2}) ** 2 - 5 * ({x_1}) * ({x_2}) + 11 * ({x_1}) + 8 * ({x_2}) - 3'
    if ex != 0:
        return lambda x1, x2: 2 * x_1 ** 2 + 4 * x_2 ** 2 - 5 * x_1 * x_2 + 11 * x_1 + 8 * x_2 - 3
    return 2 * x_1 ** 2 + 4 * x_2 ** 2 - 5 * x_1 * x_2 + 11 * x_1 + 8 * x_2 - 3
...
def gradient(x_1_0, x_2_0, eps, lambd):
    ...
    for i in range(100):
        ...
        print(f"delt_f(x_{counter}) = {eval(str(diff(f(x_1, x_2),x_1)).replace('x_1', str(x_1_0)).replace('x_2', str(x_2_0))), eval(str(diff(f(x_1, x_2),x_2)).replace('x_1', str(x_1_0)).replace('x_2', str(x_2_0)))}")
...
print("Gradient: ")
print(gradient(x_1_0, x_2_0, 0.0001, 0.25))
print("")
print("Coordinate descent method: ")
print(coordinate_descent_method(x_1_0, x_2_0, 0.0001))
print("")
print("Coordinate descent method with newton: ")
print(coordinate_descent_method_with_2_lab(x_1_0, x_2_0, 0.0001))
print("")
print("Steepest descent method: ")
print(steepest_descent_method(x_1_0, x_2_0, 0.0001))
print("")
print("Steepest descent method with newton: ")
print("")
print(steepest_descent_method_with_2_lab(x_1_0, x_2_0, 0.0001))